      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">Plataforma de e-commerce distribuÃ­da com microserviÃ§os.</p>
          </div>
          <div>
          ...
          <div>
            <h3 className="text-white font-semibold mb-3">ServiÃ§os</h3>
            <ul className="space-y-2 text-sm">
              <li>KLL Store - CatÃ¡logo</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
          <p>&copy; 2025 KLL Platform â€” Distributed E-Commerce Ecosystem</p>
        </div>
      </div>
    </footer>
  );
