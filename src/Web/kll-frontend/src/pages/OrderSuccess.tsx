...
export default function OrderSuccess() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-16 text-center">
      ...
      <p className="text-gray-500 mt-2">Seu pedido foi criado com sucesso e estÃ¡ aguardando pagamento via PIX.</p>
      ...
      <div className="flex gap-4 mt-8 justify-center">
        ...
        <Link to="/" className="btn-secondary flex items-center gap-2"><FiHome /> InÃ­cio</Link>
      </div>
    </div>
  );
}