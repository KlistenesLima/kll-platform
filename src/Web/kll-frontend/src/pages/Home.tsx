...
const categories = [
  ...
  { name: 'Computers', emoji: 'ðŸ’»', color: 'from-purple-500 to-purple-600' },
  { name: 'Audio', emoji: 'ðŸŽ§', color: 'from-pink-500 to-pink-600' },
  { name: 'Furniture', emoji: 'ðŸª‘', color: 'from-amber-500 to-amber-600' },
  { name: 'Peripherals', emoji: 'ðŸ–±ï¸', color: 'from-green-500 to-green-600' },
  { name: 'Gaming', emoji: 'ðŸŽ®', color: 'from-red-500 to-red-600' },
];
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              A melhor experiÃªncia de compra com <span className="text-accent-400">entrega rastreada</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex items-start gap-4 p-6 card">
            ...
            <div>
              <h3 className="font-semibold">PIX InstantÃ¢neo</h3>
              <p className="text-sm text-gray-500 mt-1">Pagamento processado via KRT Bank com confirmaÃ§Ã£o em segundos</p>
            </div>
          </div>
          <div className="flex items-start gap-4 p-6 card">
      ...
      <section className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold mb-4">Arquitetura DistribuÃ­da</h2>
          <p className="text-gray-400 max-w-2xl mx-auto mb-8">
            4 microserviÃ§os .NET 8 comunicando via Kafka e HTTP, com API Gateway YARP, PostgreSQL por serviÃ§o, Redis cache e integraÃ§Ã£o com KRT Bank.
          </p>
