...
public class LoginHandlerTests
{
    ...
    [Fact]
    public async Task Handle_WhenPasswordIncorrect_ShouldReturnError()
    {
    ...
    [Fact]
    public async Task Handle_WhenStatusPendingEmail_ShouldReturnError()
    {
    ...
    [Fact]
    public async Task Handle_WhenStatusPendingApproval_ShouldReturnError()
    {
        var user = AppUser.Create("Test", "test@email.com", "12345678900",
            BCrypt.Net.BCrypt.HashPassword("Senha123"));
        user.ConfirmEmail();
    ...
    [Fact]
    public async Task Handle_WhenValid_ShouldIncludeRoleInToken()
    {
        var user = CreateActiveUser();
    ...
    [Fact]
    public async Task Handle_ShouldAcceptEmailOrDocument()
    {
        var user = CreateActiveUser();
