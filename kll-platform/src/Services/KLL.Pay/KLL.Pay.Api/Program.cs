using KLL.BuildingBlocks.CQRS.Extensions;
...
builder.Services.AddCQRS(typeof(KLL.Pay.Application.Services.TransactionService).Assembly);
...
builder.Services.AddOutboxProcessor<PayDbContext>();
