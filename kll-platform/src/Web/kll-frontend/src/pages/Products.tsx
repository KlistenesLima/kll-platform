...
const mockProducts: Product[] = [
  { id: '1', name: 'Smartphone Galaxy S24 Ultra', description: 'Tela 6.8" AMOLED, 256GB, Câmera 200MP', price: 6499.90, stockQuantity: 45, category: 'Electronics', imageUrl: null, isActive: true, createdAt: new Date().toISOString() },
  ...
  { id: '3', name: 'Fone JBL Tune 770NC', description: 'Bluetooth 5.3, Cancelamento de Ruído, 44h bateria', price: 399.90, stockQuantity: 120, category: 'Audio', imageUrl: null, isActive: true, createdAt: new Date().toISOString() },
  { id: '4', name: 'Cadeira Gamer ThunderX3', description: 'Encosto reclinável 180°, apoio de braço 4D', price: 1899.00, stockQuantity: 8, category: 'Furniture', imageUrl: null, isActive: true, createdAt: new Date().toISOString() },
  ...
  { id: '7', name: 'Teclado Mecânico Keychron K8', description: 'Hot-swap, RGB, Bluetooth 5.1, Switches Gateron', price: 699.90, stockQuantity: 34, category: 'Peripherals', imageUrl: null, isActive: true, createdAt: new Date().toISOString() },
  ...
  { id: '12', name: 'Mesa Digitalizadora Wacom', description: 'Intuos Pro Medium, 8192 níveis de pressão', price: 2199.00, stockQuantity: 11, category: 'Peripherals', imageUrl: null, isActive: true, createdAt: new Date().toISOString() },
];
