...
const mockTracking = {
  ...
  events: [
    { description: 'Pacote em trânsito para cidade destino', location: 'Centro de Distribuição SP', timestamp: '2025-02-13T14:00:00Z' },
    { description: 'Pacote coletado pelo motorista', location: 'Centro de Distribuição SP', timestamp: '2025-02-13T09:00:00Z' },
...
export default function Tracking() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <p className="text-gray-500 mb-8">Insira o código de rastreamento para acompanhar sua entrega</p>
        ...
        <div className="card">
          <div className="p-6 border-b">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div><span className="text-gray-500">Destinatário:</span> {result.recipientName}</div>
              <div><span className="text-gray-500">Destino:</span> {result.destinationCity}</div>
              <div><span className="text-gray-500">Previsão:</span> {new Date(result.estimatedDelivery).toLocaleDateString('pt-BR')}</div>
            </div>
          </div>
